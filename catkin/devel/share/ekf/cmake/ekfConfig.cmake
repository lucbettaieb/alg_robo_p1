...
if("TRUE" STREQUAL "TRUE")
  set(ekf_SOURCE_PREFIX /home/luc/ros_workspace/alg_robo_p1/catkin/src/ekf)
  set(ekf_DEVEL_PREFIX /home/luc/ros_workspace/alg_robo_p1/catkin/devel)
  set(ekf_INSTALL_PREFIX "")
  set(ekf_PREFIX ${ekf_DEVEL_PREFIX})
else()
  set(ekf_SOURCE_PREFIX "")
  set(ekf_DEVEL_PREFIX "")
  set(ekf_INSTALL_PREFIX /home/luc/ros_workspace/alg_robo_p1/catkin/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ekf' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'luc <luc@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ekf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/luc/ros_workspace/alg_robo_p1/catkin/src/ekf/${idir}'.  Ask the maintainer 'luc <luc@todo.todo>' to fix it.")
    endif()
